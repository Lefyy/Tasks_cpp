...
MainMenuAction parseMainMenuAction(const std::string& token) {
    ...
    if (token == std::to_string(static_cast<int>(MainMenuAction::BuyTools))) {
        return MainMenuAction::BuyTools;
    }
    ...
    if (token == std::to_string(static_cast<int>(MainMenuAction::MyTools))) {
        return MainMenuAction::MyTools;
    }
